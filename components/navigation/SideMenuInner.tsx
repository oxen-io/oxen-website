  ...
  return (
    ...
    >
      <a href="https://t.me/Oxen_Community" target="_blank" rel="noreferrer">
        <TelegramSVG className="h-10 placeholder-current duration-300 border rounded-full cursor-pointer fill-current stroke-current desktop:h-10 hover:bg-primary hover:text-secondary border-primary" />
      </a>
      <a href="https://twitter.com/Oxen_io" target="_blank" rel="noreferrer">
        <TwitterSVG className="h-10 placeholder-current duration-300 border rounded-full cursor-pointer fill-current stroke-current desktop:h-10 hover:bg-primary hover:text-secondary border-primary" />
      </a>
      <a href="https://github.com/oxen-io" target="_blank" rel="noreferrer">
        <GithubSVG className="h-10 placeholder-current duration-300 border rounded-full cursor-pointer fill-current stroke-current desktop:h-10 hover:bg-primary hover:text-secondary border-primary" />
      </a>
      {/* <a
        ...
        rel="noreferrer"
      >
        <DiscordSVG className="h-10 placeholder-current duration-300 border rounded-full cursor-pointer fill-current stroke-current desktop:h-10 hover:bg-primary hover:text-secondary border-primary" />
      </a> */}
      <a
        ...
        rel="noreferrer"
      >
        <YouTubeSVG className="h-10 placeholder-current duration-300 border rounded-full cursor-pointer fill-current stroke-current desktop:h-10 hover:bg-primary hover:text-secondary border-primary" />
      </a>
      <a
        ...
        rel="noreferrer"
      >
        <RedditSVG className="h-10 placeholder-current duration-300 border rounded-full cursor-pointer fill-current stroke-current desktop:h-10 hover:bg-primary hover:text-secondary border-primary" />
      </a>
      <a href="https://sessiongroups.com/" target="_blank" rel="noreferrer">
        <SessionSVG className="h-10 placeholder-current duration-300 border rounded-full cursor-pointer fill-current stroke-current desktop:h-10 hover:bg-primary hover:text-secondary border-primary" />
      </a>
      <a href="/feed" target="_self" rel="noreferrer">
        <RssSVG className="h-10 placeholder-current duration-300 border rounded-full cursor-pointer fill-current stroke-current desktop:h-10 hover:bg-primary hover:text-secondary border-primary" />
      </a>
    </div>
  );
};
